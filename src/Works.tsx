...
export default function Works() {
    return (
        <div className="p-4">
            ...
            <div className="mt-8 flex gap-8 p-4 flex-wrap justify-around pb-12 flex-col lg:flex-row">
                <div className="p-4 bg-[rgba(246,148,251,.2)] backdrop-blur-md rounded-xl w-full lg:w-1/4 self-stretch flex gap-2 flex-col min-h-[200px] hover:bg-[rgba(246,148,251,.4)] cursor-pointer">
